...
class PlacesDetailsPage extends StatefulWidget {
  ...
  static const String routeName = '/places-details';

  /// The place ID to display details for
  final String placeId;

  /// Creates a new [PlacesDetailsPage] instance
  const PlacesDetailsPage({super.key, required this.placeId});

  @override
  State<PlacesDetailsPage> createState() => _PlacesDetailsPageState();
}
